...
dino_data %>%
  summarize(r = cor(x, y))
```
The correlation coefficient for the dino data r = -0.0645. This shows that there is a very weak negative relationship between x and y, so when x increases, y tends to decrease. Although again, this represents a very weaks relationship and shows that the two variables are hardly correlated at all.
